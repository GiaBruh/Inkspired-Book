                    ...
                    <div class="user_forms-login">
                        ...
                        <form class="forms_form" method="POST"
                            ...
                            <fieldset class="forms_fieldset">
                                ...
                                <div class="forms_field">
                                    <input type="checkbox" name="remembermecheckbox" id="remember_me">
                            ...
                            <div class="forms_buttons">
                                ...
                                <label class="form-check-label fw-bolder">
                                    <button type="button" class="forms_buttons-forgot" data-bs-toggle="modal"
                                            data-bs-target="#emailVerification">
                                        Forgot password?
                                    </button>
                                </label>
                    ...
                    <div class="user_forms-signup">
                        ...
                        <form class="forms_form" method="POST"
                            ...
                            <div class="forms_buttons justify-content-center pb-md-5">
                                <input type="submit" value="Submit" name="btnsubmitRegister"
                                       class="forms_buttons-action" disabled>
                            </div>
                        </form>
                    </div>
                </div>
